...
parser.add_argument('--exp_name', type=str, default="hyper", help="name of experiment")
...
parser.add_argument("--patch_size", default=128, type=int, help='cropped patch, ground truth size')
parser.add_argument("--max_epoch", type=int, default=201, help='total epoch')
...
parser.add_argument("--full_size_test", type=bool, default=True, help='whether to evaluate full-size images')
