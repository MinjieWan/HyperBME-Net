...
```
python train_and_test.py --train_phase 2  --clip_grad --batch_size 64 --template hyper --outf ./exp/hyper_2nd/ --resume_ckpt_path ./exp/hyper_1st/model/model_epoch_xxx.pth --method hyper --stage 3 --body_share_params 0 
```
