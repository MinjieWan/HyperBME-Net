...
def merge_network_opt(parser):
    ...
    parser.add_argument('--in_dim', type=int, default=60, help='model\'s input dimension')
    parser.add_argument('--out_dim', type=int, default=60, help='model\'s output dimension')
    parser.add_argument('--dim', type=int, default=60, help='model\'s block dimension')
    ...
    #####ldm#####
    parser.add_argument('--train_phase', type=int, default=0, help="training phase for hyper")
